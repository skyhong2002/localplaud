...
- [ ] (P2) Keyboard & a11y: preserved-data chips in the bulk cleanup warning are generic spans rather than a semantic list, so assistive technology cannot announce them as a grouped set — 2026-07-22 browser accessibility-tree audit
- [ ] (P2) Library table: the Traditional Chinese bulk toolbar still renders `No folder` in English — 2026-07-22 browser audit; `/tmp/localplaud-polish-20260722/bulk-delete-separation/desktop-warning-final-1400x900.png`
- [ ] (P2) Library table: Traditional Chinese source navigation and the active-filter summary render numbered capture sources as English `Source 1` / `Capture source 1` — 2026-07-22 browser verification at 1400x900 and 390x844; `/tmp/localplaud-polish-20260722/active-filter-empty/mobile-before-reset-390x844.png`
