...
- [ ] (P2) Library table: deleting the currently filtered folder or tag can leave or resurrect a stale selected filter through browser history, producing an empty library for a now-missing organization ID — 2026-07-22 browser verification; Back returned to `?view=all&tag=1` after deleting that tag
