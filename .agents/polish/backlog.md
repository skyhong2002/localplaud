...
- [ ] (P3) Keyboard & a11y: literal English aria-labels remain in the TC shell outside the bulk toolbar — `notifications.html` Dismiss button, `settings.html` "Settings sections" nav, and `index.html:326` orgbox "Library organization" — 2026-07-22 grep audit
