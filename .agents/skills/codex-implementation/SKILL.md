...
Keep prompts short and direct. State the task, the paths, the constraints, and the expected deliverable. Do not prompt it like Codex — no role-play, no elaborate guardrails. Codex won't do things you didn't ask for.
